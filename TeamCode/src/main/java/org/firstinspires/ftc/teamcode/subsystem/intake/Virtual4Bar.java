...
public class Virtual4Bar {
    ...
    public static double clawOpen = 0.5, clawClose = 0.19, transferOpen = 0.3;
    public static double v4bGround = 1.0, v4bTransfer = 0.485, v4bPreTransfer = 0.6, v4bStackHigh = 0.95, v4bStackMid = 0.97;
