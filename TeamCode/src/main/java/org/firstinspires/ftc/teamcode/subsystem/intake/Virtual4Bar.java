...
public class Virtual4Bar {
    ...
    public static double clawOpen = 0.5, clawClose = 0.2, transferOpen = 0.3;
    public static double v4bGround = 0.96, v4bTransfer = 0.46, v4bPreTransfer = 0.56, v4bStackHigh = 0.95, v4bStackMid = 0.97;
