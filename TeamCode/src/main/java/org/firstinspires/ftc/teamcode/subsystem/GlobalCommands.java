...
public class GlobalCommands{
    ...
    public static SequentialCommandGroup getTransfer(Robot r){
        return new SequentialCommandGroup(new FunctionalCommand(() -> {r.startTime = System.nanoTime();}, ()->{r.d.setArm(NewDeposit.armTransfer);}, (Boolean ended) -> {}, () -> System.nanoTime() - r.startTime > ARM_DELAY * 1e9),
