...
public class BlueAudiemceSide extends LinearOpMode {
    ...
    public void runOpMode(){
        ...
        Pose2d startpose = new Pose2d(-38+9.625, 58, Math.toRadians(-90));
        ...
        TrajectorySequence leftPurple = drive.trajectorySequenceBuilder(startpose)
                ...
                .splineToConstantHeading(new Vector2d(-28, 35), Math.toRadians(-180))
                ...
                .lineToSplineHeading(new Pose2d(56,38.5, Math.toRadians(-180)))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
        ...
        TrajectorySequence middlePurple = drive.trajectorySequenceBuilder(startpose)
                ...
                .lineToSplineHeading(new Pose2d(56.5,34, Math.toRadians(-180)))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    bucket.setPosition(0.95);
                })
                .waitSeconds(0.4)
        ...
        TrajectorySequence rightPurple = drive.trajectorySequenceBuilder(startpose)
                ...
                .lineToSplineHeading(new Pose2d(56,26, Math.toRadians(-180)))
                .UNSTABLE_addTemporalMarkerOffset(0, () -> {
                    bucket.setPosition(0.95);
                })
                .waitSeconds(0.4)
